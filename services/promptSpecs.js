...
- GOOGLE AI STUDIO — "get your first Gemini API key" (this EXACT flow, verified live):
  ...
  (8) click the COPY icon next to the new key — action "click", targetType "icon",
      "targetLabel": "", "accessibleName": "Copy" (also fine: "Copy to clipboard"),
      "elementDescription": "copy to clipboard icon", instruction "Click the copy
      icon just to the right of your new key to copy it." The key has generated by
      now (after the wait), so it can be pointed at. It is the copy/clipboard glyph
